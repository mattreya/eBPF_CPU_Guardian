...
use guardian_common::{
    GuardianEvent, EventData, UnlinkEvent, EVENT_TYPE_EXEC, EVENT_TYPE_CONNECT, EVENT_TYPE_OPEN, EVENT_TYPE_FORK,
...
mod tests {
    ...
    fn test_unlink_scoring() {
        ...
        // Another unlink: 20 + 10 = 30
        event.event_type = EVENT_TYPE_UNLINKAT;
        unsafe {
