...
use guardian_common::{GuardianEvent, EventData, ExecEvent, ForkEvent, UnlinkEvent, EVENT_TYPE_EXEC, EVENT_TYPE_CONNECT, EVENT_TYPE_OPEN, EVENT_TYPE_FORK, EVENT_TYPE_UNLINK, EVENT_TYPE_UNLINKAT};
...
mod tests {
    ...
    fn test_unlink_scoring() {
        ...
        let score = analyzer.processes.get(&1234).unwrap().score;
        assert_eq!(score, 20); // 10 base + 10 for pdf
    }
}
